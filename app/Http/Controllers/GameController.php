    ...
    public function bet(Request $request)
     {
        ...
        if($bet > 0){
            ...
            $user->subtract(round($bet / 100, 2), 'usd', $gamestatus, json_encode(array("game" => $gameid, "round" => $roundid)));
        }

        if($win > 0) {
            $user->add(round($win / 100, 2), 'usd', $gamestatus, json_encode(array("game" => $gameid, "round" => $roundid)));
        }
