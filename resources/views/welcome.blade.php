...
<div class="flex flex-wrap max-w-7xl mx-auto sm:px-3 lg:px-4">
    ...
    <div data-tilt-scale="1.05" data-tilt-max="10" data-tilt-speed="500" data-tilt-perspective="1000" data-tilt class="xl:w-1/7 lg:w-1/5 md:w-1/4 sm:w-1/3 w-1/2 sm:p-4 p-2 my-2 pulse">
        @if($game["ext"] === "c2")
        ...
        @endif
            <div class="group cursor-pointer bg-gray-200 rounded-lg transition duration-400 ease hover:bg-primary hover:shadow-2xl">
                ...
                <img class="welcome-big-thumbnail rounded-t-lg" src="https://cdn.apigamble.com/i/long/jpg/{{$game['_id']}}.jpg" alt="">
