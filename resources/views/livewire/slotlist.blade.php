...
const element = document.querySelector("#game-slot");
...
<div class="flex flex-wrap mt-2 max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    @if($slotslist['p'] == 'pragmatic')
    <div data-tilt-scale="1.1" data-tilt-max="10" data-tilt-speed="300" data-tilt-perspective="1000" data-tilt class="xl:w-1/7 lg:w-1/6 md:w-1/4 sm:w-1/3 w-1/2 px-3 my-4 wire:loading.remove">
